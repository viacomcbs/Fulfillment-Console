...
public class LF_LI_007_ValidateSelectAllSelectsAll extends LeftFilterLineItemsTabBaseTest {

    @Test(priority = 0)
    @Description("Validate Select all selects all options on Line items tab")

...
public class DFOC_LI_AssignedTo_ValidateNoDuplicateFilterOptionsOnSearch extends DuplicateFilterOptionsLineItemsTabBaseTest {

    private static final String FILTER_NAME = LineItemsLeftFilter.ASSIGNED_TO.getDisplayName();

    @Test(priority = 0)
    @Description("Validate narrow search inside Assigned To filter on Line items tab returns exactly one result per option (no duplicates)")

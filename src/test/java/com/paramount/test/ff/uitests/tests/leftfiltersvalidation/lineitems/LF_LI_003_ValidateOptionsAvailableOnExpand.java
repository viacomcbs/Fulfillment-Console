...
public class LF_LI_003_ValidateOptionsAvailableOnExpand extends LeftFilterLineItemsTabBaseTest {

    @Test(priority = 0)
    @Description("Validate filter options are available when expanded on Line items tab")

...
/**
 * Left-panel filter names for the Orders tab (from msc-left-filter-panel HTML).
 */
public enum OrdersLeftFilter {
    ...
    OrdersLeftFilter(String displayName) {
    ...
    public static List<String> allDisplayNames() {
        return Arrays.stream(values())
                .map(OrdersLeftFilter::getDisplayName)

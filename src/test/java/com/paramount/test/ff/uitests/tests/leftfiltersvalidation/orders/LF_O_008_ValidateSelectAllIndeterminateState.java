...
public class LF_O_008_ValidateSelectAllIndeterminateState extends LeftFilterOrdersTabBaseTest {

    @Test(priority = 0)
    @Description("Validate Select all indeterminate state and deselect all on Orders tab")

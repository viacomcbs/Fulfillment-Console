...
public class SoftAssert_bk extends org.testng.asserts.SoftAssert {
	...
	public SoftAssert_bk(String methodName) {
	...
	public SoftAssert_bk(String methodName, String className) {
		this.fullMethodName = methodName;
	...
	public void assertValidate(boolean actual, String message) {
		...
		if (actual) {
			...
			Logger.logReportMessage(message+" : PASS");
		} else {
	...
	public void uploadFileToServer(String fileName, File pdfFile) throws IOException {
		...
		String url = fileUploader.uploadFile(pdfFile); // the file and
															// number of days to
															// retain
	...
	public void downloadFileFromServer(String fileName, String fileUrl) throws IOException {
		FileUploader fileUploader = new FileUploader("https://www.synergyserver.tech?key=" + ConfigProps.USER_KEY);
		File srcFile = fileUploader.downloadFile(fileUrl); // the file and
															// number of days to
															// retain
	...
	public void mergeScreenshotsToPDF() {
		...
		// copy pdf file to common pdf folder
